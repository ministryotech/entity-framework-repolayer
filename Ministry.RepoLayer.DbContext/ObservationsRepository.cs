...
namespace Ministry.RepoLayer.DbContext.Repositories
{
	...
	/// </summary>
	public partial class ObservationsRepository : RepositoryBase<IEdmContextWrapper, Observation, Response, System.Guid>, IObservationsRepository
	{
        /// <summary>
        ...
        public ObservationsRepository(IEdmContextWrapper contextWrapper)
            : base(contextWrapper)
        { }
